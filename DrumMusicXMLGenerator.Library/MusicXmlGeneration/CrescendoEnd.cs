...
{
    /// <summary>
    /// Ends a crescendo immediately after this note such that it contains this note.
    /// Does nothing unless there is a <see cref="Crescendo"/> on some previous note.
    /// </summary>
    public class CrescendoEnd:IRudiment
    {
        /// <summary>
