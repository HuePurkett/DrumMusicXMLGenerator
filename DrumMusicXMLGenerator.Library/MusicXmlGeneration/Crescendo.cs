...
{
    /// <summary>
    /// Adds a crescendo to the note.
    /// Does not work unless there is a <see cref="CrescendoEnd"/> on some subsequent note.
    /// </summary>
    public class Crescendo:IRudiment
    {
        /// <summary>
        ...
        public XElement GetXml()
        {
            ...
            dirnote.AddFirst(XElement.Parse("<direction><direction-type><wedge type=\"crescendo\"/></direction-type></direction>"));
            return dirnote;
        }
